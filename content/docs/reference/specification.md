...
[extra]
lead = "Biscuit, a bearer token with offline attenuation and decentralized verification"
toc = true
top = false
+++

*This is the specification for Biscuit tokens at version 3, released on March 28th, 2023, mirroring the document on the [Github repository](https://github.com/biscuit-auth/biscuit/blob/main/SPECIFICATIONS.md).*
